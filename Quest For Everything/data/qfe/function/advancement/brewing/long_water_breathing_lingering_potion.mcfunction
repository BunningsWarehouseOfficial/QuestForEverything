...
function qfe:universal/handle_item_lore_advanced {'item':'minecraft:lingering_potion', 'components':'"minecraft:potion_contents":{potion:"minecraft:long_water_breathing"}'}
