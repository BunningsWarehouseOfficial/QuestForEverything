...
function qfe:universal/handle_item_lore_advanced {'item':'minecraft:splash_potion', 'components':'"minecraft:potion_contents":{potion:"minecraft:long_turtle_master"}'}
